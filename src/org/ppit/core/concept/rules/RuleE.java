 ...
 * 
 * @author SedrakG
 * @description this is RuleE class that describes rule Equals to ("=")
 *
 */
public class RuleE extends IRule {
	/**
	 ...
	 */
	private HashMap<String, ArrayList<Expression>> m_dependencyMap = null;
	/**
	 * @brief Constructor
	 * @param expression String expression of the Rule Equals
	 * @throws InvalidExpression 
	 */
	public RuleE(String expression) throws InvalidExpression
	{
