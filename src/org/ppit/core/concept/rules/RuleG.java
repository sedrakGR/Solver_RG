 ...
 * 
 * @author SedrakG
 * @description this is RuleG class that describes rule Greater(">")
 *
 */
public class RuleG extends IRule {
	 ...
	 */
	public RuleG(String ruleExpression) throws InvalidExpression
	{
	...
	{
		return Definitions.greaterOperator;
	}
	...
	public ArrayList<IRule> conjunction(IRule rule) {
		IRule rule0 = null;
		try {
			rule0 = new RuleGE((this.getValues().get(0) + 1) + "");
